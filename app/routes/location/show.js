...
// in the `then` function call, another API call is made to get the topExports data
  ...
  afterModel: function(model) {
    ...
    return RSVP.allSettled([products, dotplot, industries, subregions_trade, occupations, agproducts, ag_farmsizes, nonag_farmsizes]).then((array) => {
      ...
      var agFarmsizesData = getWithDefault(array[6], 'value.data', []);
      var nonagFarmsizesData = getWithDefault(array[7], 'value.data', []);
