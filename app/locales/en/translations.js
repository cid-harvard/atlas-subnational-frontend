export default {
  ...
  'graph_builder': {
    ...
    'page_title': {
      ...
      'location': {
        'locations.export': 'What countries does this location export to?',
        'locations.export_to': 'What countries does this location export {{item}} to?',
        'locations.import_from': 'What countries does this location import from?',
        'locations.import_product_from': 'What countries does this location import {{item}} from?',
        'locations.export_subregions': 'What subregions contribute to the exports from this location?',
        'locations.export_subregions_products': 'What subregions contribute to the exports of {{item}} from this location?',
        'locations.export_subregions_locations':'What subregions contribute to the exports from this location to {{place}}?',
        'locations.export_subregions_products_locations':' What subregions contribute to the exports of {{item}} from this location to {{place}}?',
        'locations.import_subregions': 'What subregions contribute to the imports for this location?',
        'locations.import_subregions_products': 'What subregions contribute to the imports of {{item}} for this location?',
        'locations.import_subregions_locations': 'What subregions contribute to the imports for this location from {{place}}?',
        'locations.import_subregions_products_locations': 'What subregions contribute to the imports of {{item}} for this location from {{place}}?',
        'products.export_value': 'What products does this location export?',
        'products.scatter': 'What products have the most potential for this location?',
        'products.export_value_to': 'What products does this location export to {{place}}?',
        'products.import_value': 'What products does this location import?',
        'products.import_value_from': 'What products does this location import from {{place}}?',
        'products.similarity': 'What does the product space look like for this location?',
        'industries.employment': 'What industries in this location employ the most people?',
        'industries.scatter': 'What industries have the most potential for this location?',
        'industries.wages': 'What industries in this location are the largest by total wages?',
        'industries.wages_avg': 'What industries in this location have the highest wages per worker?',
        'industries.similarity': 'What does the industry space look like for this location?'
      }
    },
    'builder_nav': {
